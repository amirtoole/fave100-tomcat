...
public final class MusicbrainzTokenizer extends Tokenizer {
	 ...
	 */
	public MusicbrainzTokenizer(final Version matchVersion, final Reader input) {
		super(input);
	 ...
	 */
	/*public MusicbrainzTokenizer(final Version matchVersion, final AttributeSource source, final Reader input) {
		super(source, input);
		this.scanner = new MusicbrainzTokenizerImpl(input);
		init(input, matchVersion);
	}*/
	 ...
	 */
	public MusicbrainzTokenizer(final Version matchVersion, final AttributeFactory factory, final Reader input) {
		super(factory, input);
		this.scanner = new MusicbrainzTokenizerImpl(input);
		init(input, matchVersion);
	}
